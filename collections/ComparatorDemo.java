...
public class ComparatorDemo {
	...
	//	Set<Employee> eset=new TreeSet<Employee>(new SalaryComparator());
		...
		System.out.println(" Name sorted order");
		System.out.println(eset);
		Collections.sort(eset,new IdComparator());
		System.out.println(" Id sorted order");
		System.out.println(eset);
		Collections.sort(eset,new SalaryComparator());
		System.out.println(" Salary sorted order");
		System.out.println(eset);
	}
}
